            ...
            <div class=" flex flex-row space-x-4">
                ...
                <div class="flex flex-row">
                 ...
                 <div class="pt-6 pl-5 row-end-4">
                    <a href="http://localhost/IP/createAccount.php">Create Account</a>
                    <a href="http://localhost/IP/signIn.php">Sign In</a>
                </div>
                <div>
...
<section class="max-w-4xl p-6 mx-auto rounded-md shadow-md bg-orange-200 mt-20">
    ...
    <form action = "registerShop_db.php" method = "post">
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <input id="address" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md  dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>
            <div>
                <label class=" text-black" for="passwordConfirmation">จังหวัด </label>
                <select id="state" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md  dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            ...
            <div>
                ...
                <input id="size"type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md  dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>
            <div>
            ...
            <div>
                ...
                <textarea id="detail" type="textarea" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md  dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
            </div>
            <div>
                <label id = "photo"class="block text-sm font-medium text-black">
                รูปสินค้า 
              </label>
        ...
        <div class="flex justify-end mt-6">
            <button type = "submit" name = "save" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600">Save</button>
        </div>
    </form>
</section>
